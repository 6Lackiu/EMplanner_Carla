...
while True:
    ...
    s_map = planner_utils.cal_s_map_fun(global_frenet_path, origin_xy=(vehicle_loc.x, vehicle_loc.y))
    ...
    if len(possible_obs) != 0:
        ...
        obs_s_list, obs_l_list = planner_utils.cal_s_l_fun(obs_xy, global_frenet_path, s_map)
