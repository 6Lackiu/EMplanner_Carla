...
def motion_planning(conn):
    while 1:
        ...
        local_frenet_path_opt_ = planner_utils.smooth_reference_line(local_frenet_path_)
        ...
        current_local_frenet_path_opt = motion_plan_path_planning.frenet_2_x_y_theta_kappa(plan_start_s=begin_s_list[0],
